...
namespace Gallatin.Core.Tests.Web
{
    ...
    public class HttpMessageParserTests
    {
        ...
        public void ParseRequestTest()
        {
            ...
            IEnumerator<KeyValuePair<string, string>> headerEnumeration =
                requestMessage.Headers.AsEnumerable().GetEnumerator();
        ...
        public void ParseResponseWithChunkedData()
        {
            ...
            Assert.That( response.Headers,
                         Has.Member( new KeyValuePair<string, string>( "Content-Length", "52177" ) ) );

            // The body should equal the control file
            byte[] controlData =
                File.ReadAllBytes( "testdata\\response chunked body reassembled.raw" );
        ...
        public void ParseResponseWithContentLengthSpecified()
        {
            ...
            Assert.That( response.Headers,
                         Has.Member( new KeyValuePair<string, string>( "Content-Length", "2891" ) ) );
        }
    }
}